...
if __name__ == '__main__':
    ...
    # results_dir = 'D:/Shivesh/CUTGan/Results/CUTgan_train_v5_v2_' + str(run) + '_' + str(tsize)
    results_dir = '/storage/scratch1/0/schaudhary9/CUTGan/Results/CUTgan_train_v5_lsgan_newtrain_batch_' + str(run) + '_' + str(tsize)
