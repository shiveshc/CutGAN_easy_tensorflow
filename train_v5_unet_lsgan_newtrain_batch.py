...
if __name__ == '__main__':
    ...
    gen_loss = 10*gen_adv_loss + f_cont_loss
    ...
    results_dir = '/storage/scratch1/0/schaudhary9/CUTGan/Results/CUTgan_train_v5_unet_lsgan_newtrain_batch_' + str(run) + '_' + str(tsize)
